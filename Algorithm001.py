...
'''
"--입력--"
print("첫 번째 줄에는 보드의 세로, 가로 크기를 의미하는 두 정수 N, M (3 ≤ N, M ≤ 10)이 주어진다.")
print("다음 N개의 줄에 보드의 모양을 나타내는 길이 M의 문자열이 주어진다.")
print("이 문자열은 '.', '#', 'O', 'R', 'B' 로 이루어져 있다.")
print("'.'은 빈 칸을 의미하고, '#'은 공이 이동할 수 없는 장애물 또는 벽을 의미하며, 'O'는 구멍의 위치를 의미한다.")
print("'R'은 빨간 구슬의 위치, 'B'는 파란 구슬의 위치이다.")
print("입력되는 모든 보드의 가장자리에는 모두 '#'이 있다. 구멍의 개수는 한 개 이며, 빨간 구슬과 파란 구슬은 항상 1개가 주어진다.")
print("")
"--출력--"
...
def insert_board(h,w,i): 
    ...
    while i < h:
        ...
        for j in list(s):
            count += 1
        # if w != "#" or "." or "R" or "B" or "O":
        #     print("알맞은 값을 입력해 주세요.")
        #     insert_board(h,w,i)
        #     break
        if count != w:
